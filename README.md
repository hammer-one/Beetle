...
- **BRUTE_FORCE_HYDRA**- Es una herramienta para pruebas de fuerza bruta en protocolos ftp, smb, smtp, ssh, etc.
...
- **JAMMER_DETECT** — Función para detección de equipos Jammer en redes wifi, indicando canal, potencia de ataque.
- **ANALYZER_WIFI** — Función para analizar el tráfico wifi, medición temporal de canal mas saturado.
...
- función de colaboración con wap-sec para subir los handshakes capturados, se necesita configurar la key API.
